        ...
        public void SetParticleComponents()
        {
            ...
            if (HasDust == true)
                for (int i = dustList.Count - 1; i >= 0; i--)
                {
                    ...
                    {
                        if (dustList[i].HasChildren == true)
                            for (int c = dustList[i].children.Count - 1; c >= 0; c--)
                                if (dustList[i].children[c] == null)
                                    dustList[i].children.RemoveAt (c);
                    }
                }
